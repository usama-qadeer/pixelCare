...
class _NationalInsuranceState extends State<NationalInsurance> {
  ...
  Future<void> getNationalInsurance() async {
    try {
      ...
      body: SingleChildScrollView(
        child: Container(
            ...
            child: Form(
              key: formKey,
              child: FutureBuilder(
                future: DocumentController().NationalInsuranceGet(),
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: _nationalInsuranceModel != null
                                      ? _nationalInsuranceModel!
                                          .data!.first.insuranceNumber
