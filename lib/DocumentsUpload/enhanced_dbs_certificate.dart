...
class EnhanceDBSCertificate extends StatefulWidget {
  const EnhanceDBSCertificate({Key? key}) : super(key: key);

  @override
  State<EnhanceDBSCertificate> createState() => _EnhanceDBSCertificateState();
}

class _EnhanceDBSCertificateState extends State<EnhanceDBSCertificate> {
      ...
      body: SingleChildScrollView(
        child: Container(
            ...
            child: Form(
              key: formKey,
              child: FutureBuilder(
                future: DocumentController().GetDbsFromAPI(),
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: _enhancedDBSCertificate != null
                                      ? _enhancedDBSCertificate!
                                          .data!.first.dbsNumber
                                      : 'Enter DBS number',
                                ),
                              ),
                            ],
                          ...
                          onTap: () async {
                            ...
                            if (formKey.currentState!.validate()) {
                              if (images.isEmpty) {
                                ...
                                var data = await DocumentController().AddDbs(
                                    expiry: date,
                                    number: number,
                                    images: images);
                                print("////////////////////");
