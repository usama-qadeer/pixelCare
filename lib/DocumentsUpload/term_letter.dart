...
class _Term_LetterState extends State<Term_Letter> {
  ...
  @override
  void initState() {
    getTermLetterFromAPI();
    super.initState();
  }

  Future<void> getTermLetterFromAPI() async {
    try {
      ...
      body: SingleChildScrollView(
        child: Container(
            ...
            child: Form(
              key: formKey,
              child: FutureBuilder(
                future: DocumentController().TermLetterGet(),
                  ...
                  if (snapshot.data?.message == "Record Founded") {
                    return Column(
                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                "Start Date: " +
                                                    _termLetterModel!.data!
                                                        .first.termLetterStart
                                                        .toString(),
                                                style: TextStyle(
                                                    fontSize: 20,
                                                    color: Colors.white),
                        ...
                        //         child: _termLetterModel != null
                        //             ? CachedNetworkImage(
                        //                 imageUrl: _termLetterModel!.data!.first
                        //                     .documentImages!.first.upload
                        //                     .toString(),
